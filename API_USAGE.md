...
| **`B002`** | Lim Kai Xuan | `HIC-2023-00456`<br>**SILVER** | **Non-Panel Outpatient**<br>Billed by a non-panel GP clinic. Physician licence valid. Bill exceeds RPS benchmark by 100%. Non-panel 70% reimbursement applied. | **Passes to N6 (Zero Benefit)**<br>Net Payable: **SGD 0.00**<br>Adjudication base SGD 133 (190 × 70%) fully absorbed by remaining deductible (SGD 1,820). Halted at disbursement. |
