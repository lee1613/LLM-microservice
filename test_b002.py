...
async def main():
    with open(r"c:\Users\Lee023\OneDrive - National University of Singapore\Desktop\Project\LLM-microservice\data\health-insurance-claim\synthetic data\claim_B002_full_pipeline.json", "r") as f:
        data = json.load(f)
